...
if __name__ == '__main__':
    ...
    # read
    train_path = os.path.join(root, dataset_name, 'train.txt')
    test_path = os.path.join(root, dataset_name, 'test.txt')
    ...
    edge_indexs = np.stack([row, col]).tolist()
    ...
    with open('processed/pre_' + dataset_name + '.pkl', 'wb') as f:
        ...
        pickle.dump(edge_indexs, f, pickle.HIGHEST_PROTOCOL)
