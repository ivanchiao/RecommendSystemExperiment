...
class Preprocess(object):
    ...
    def __init__(self, root_path, ratio=0.8):
        ...
        self.sparse_n_features = 0  # the dimension of sparse vector (user_id, movie_id)
        self.dense_n_features = 0  # the domension of dense vector
...
if __name__ == '__main__':
    d = Preprocess('/zhaochen/RS_FIRST_EXPERIMENT/CTR/FactorMachine/data/')